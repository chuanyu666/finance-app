...
public class DataAccessConfiguration {
  ...
  private Map<String, Object> getVendorProperties(DataSource dataSource) {
    ...
    String defaultDdlMode = this.new HibernateDefaultDdlAutoProvider(
      providers.getIfAvailable(Collections::emptyList))
      .getDefaultDdlAuto(dataSource);

    vendorProperties.putAll(properties.getHibernateProperties(new HibernateSettings().ddlAuto(defaultDdlMode)
                          .physicalNamingStrategy(physicalNamingStrategy.getIfAvailable())
